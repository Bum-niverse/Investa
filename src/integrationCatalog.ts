...
export const INTEGRATION_CATALOG: IntegrationDefinition[] = [
  ...
  { id: "opendart", name: "OpenDART", kind: "disclosure", markets: ["kr"], capabilities: ["disclosures"], support: "built-in", summary: "국내 공식 공시 읽기 전용 어댑터 · API 키 필요" },
  { id: "naver-news", name: "네이버 뉴스 검색", kind: "news", markets: ["kr"], capabilities: ["news"], support: "built-in", summary: "국내 일반 뉴스 공식 검색 API · Client ID/Secret 필요" },
